 ...
 */
class ktarila_ParameterValidatorBundle_Tests_KernelTestDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'ktarila\\ParameterValidatorBundle\\Tests\\TestController\\TestController' => 'getTestControllerService',
        ...
        $this->aliases = [
            'ktarila\\ParameterValidatorBundle\\Tests\\Kernel' => 'kernel',
        ];
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once \dirname(__DIR__, 5).'/vendor/symfony/symfony/src/Symfony/Component/HttpKernel/EventListener/CacheAttributeListener.php';
    ...
    private function getDynamicParameter(string $name)
    {
        $value = match ($name) {
            ...
            'debug.container.dump' => ($this->targetDir.''.'/ktarila_ParameterValidatorBundle_Tests_KernelTestDebugContainer.xml'),
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.container_class' => 'ktarila_ParameterValidatorBundle_Tests_KernelTestDebugContainer',
