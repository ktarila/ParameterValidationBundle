 ...
 */
class getConsole_Command_CachePoolDeleteService extends ktarila_ParameterValidatorBundle_Tests_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 5).'/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Command/CachePoolDeleteCommand.php';
